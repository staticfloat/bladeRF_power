...
PREFIX="$(pwd)/prefix"
CMAKE_DFLAGS="-DENABLE_BACKEND_LIBUSB=ON -DCMAKE_INSTALL_PREFIX=$PREFIX -DCMAKE_BUILD_TYPE=Debug"
CMAKE_FLAGS="-DENABLE_BACKEND_LIBUSB=ON -DCMAKE_INSTALL_PREFIX=$PREFIX -DCMAKE_BUILD_TYPE=Release"
mkdir -p "$PREFIX"
